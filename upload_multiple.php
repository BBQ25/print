    ...
    for ($i = 0; $i < $total_files; $i++) {
        ...
        if (move_uploaded_file($file['tmp_name'], $file_path)) {
            try {
                ...
                // Insert file record with page count and security data
                $query = "INSERT INTO uploaded_files (StudentNo, original_name, file_name, file_path, file_size, file_type, page_count, mac_address, location_latitude, location_longitude, location_address, upload_date, status) VALUES (:student_no, :original_name, :file_name, :file_path, :file_size, :file_type, :page_count, :mac_address, :location_latitude, :location_longitude, :location_address, NOW(), 'completed')";
